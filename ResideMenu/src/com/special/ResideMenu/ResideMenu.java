...
public class ResideMenu extends FrameLayout {
    ...
    private ImageView imageSettingBtn;
    private LinearLayout layoutLeftMenu, layoutLeftHeader;
    ...
    private void initViews(Context context) {
        ...
        layoutLeftHeader = (LinearLayout) findViewById(R.id.layout_left_header);
        layoutRightMenu = (LinearLayout) findViewById(R.id.layout_right_menu);
        imageViewBackground = (ImageView) findViewById(R.id.iv_background);

        imageSettingBtn = (ImageView) findViewById(R.id.btn_settings);
    }
    ...
    public void setLeftMenuHeader(View view) {
        layoutLeftHeader.setVisibility(View.VISIBLE);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        layoutLeftHeader.addView(view, params);
    }

    public ImageView getSettingBtn() {
        return imageSettingBtn;
    }
